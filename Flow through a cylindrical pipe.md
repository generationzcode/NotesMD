> Bird Stewart Lightfoot uses a shell momentum balance for this, without using the equations of change
...
- This is also known as the hagen poisuelle equation, and is given in more detail in [[Fluid mechanics]]